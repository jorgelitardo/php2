...
$query = "select p.reg,p.apellidos_estudiante,p.nombres_estudiante,p.curso_estudiante,p.jornada_estudiante, p.fecha_dece_estudiante,p.psicologo,p.estado from postulantes p where p.fecha_actual BETWEEN '".$fecha_inicio."' AND '".$fecha_fin."' and anio_lectivo=2017";
//echo $query;
if ($palabra<>"Todos") {
