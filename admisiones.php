 ...
 <tr>
    ...
    <td>
      <select name="jornada_estudiante" id="jornada_estudiante">
        <?php 
        if ($jornada_estudiante == "MATUTINA") {
           echo '<option value =  "MATUTINA" selected">MATUTINA</option>';
        }else{
          echo '<option value="MATUTINA">MATUTINA</option>';
        }
        if ($jornada_estudiante == "VESPERTINA") {
           echo '<option value =  "VESPERTINA" selected>VESPERTINA</option>';
        }else{
          echo '<option value="VESPERTINA">VESPERTINA</option>';
        }
	...
	<td>
    <input type="text" value= "<?php echo $fecha_dece_estudiante; ?>" name="fecha_dece_estud" id = "fecha_dec" disabled>
	<input type="hidden" value= "<?php echo $fecha_dece_estudiante; ?>" name="fecha_dece_estudiante" id = "fecha_dec">
    </td>
    <td></td>
	</tr> 
    ...
    <td colspan="2"><input value= "<?php echo $direcc_estudiante; ?>" type="input" name="direcc_estudiante" id = "direc_est">
    <td><label>A&ntildeo Lectivo:</label></td>
    <td><input value= "<?php echo $anio_lectivo; ?>" type="input" name="anio_lectivo" id = "anio_lectivo"></td>
  </tr>
  <td><label>Medio:</label></td>
    <td><input value= "<?php echo $medio_med; ?>" type="input" name="medio_med" id = "medio_med"></td>
	</table>
       	  </fieldset>
  ...
  <tr>
    ...
    <td><label>Estado Civil</label></td>
    <td>
	<select name="estado_padre" value= "<?php echo $estado_padre; ?>" id = "est_padre" >
		<option value="">Selecciona una opcion</option>
		<option value="Casado">Casado</option>
		<option value="Soltero">Soltero</option>
		<option value="Divorciado">Divorciado</option>
  ...
  <tr>
    ...
    <fieldset class = "datos_representante" >
		...
		<tr>
		    ...
		    <td><label>Estado Civil</label></td>
		    <td>
			<select name="estado_representante" value= "<?php echo $estado_representante; ?>" id = "est_repre" >
		<option value="">Selecciona una opcion</option>
		<option value="Casado">Casado</option>
		<option value="Soltero">Soltero</option>
		<option value="Divorciado">Divorciado</option>
...
<tr>
          ...
          <tr>
		    ...
		    <td><label>Email:</label></td>
		    <td>
            <input type="email" name="email_representante" value= "<?php echo $email_representante; ?>" id = "email_repre" />
             </td>
	      </tr>
	...
	<fieldset class="datos_facturacion">
			<table width="620" border="0" cellpadding="3">
    <tr>
      <td colspan="3"><h4>Datos de Facturacion</h4></td>
    
  <tr>
    <td width="222"><label>Cedula:</label></td>
    <td width="374"><input type="text" name="cedula_fact" value= "<?php echo $cedula_fact; ?>" id = "cedula_fact" onKeyPress="return valida(event)" onChange="ced_factura(this)" maxlength = "10" /></td> 
  </tr>
  <tr>
        <td><label>Apellidos</label></td>
    <td><input type="text" name="apellidos_fact" value="<?php echo $apellidos_fact; ?>" id = "apellidos_fact"/ ></td>
       
  </tr>
  <tr>
   <td><label>Nombres</label></td>
    <td><input type="text" name="nombres_fact" value="<?php echo $nombres_fact; ?>" id = "nombres_fact"/ ></td>
  </tr>
  
  <tr>
  <td><label>Direccion</label></td>
  <td><input type="text" name="direccion_fact" value="<?php echo $direccion_fact; ?>" id = "direccion_fact"/ ></td>
  </tr>
    <tr>
    <td><label>Telefono</label></td>
    <td><input type="text" name="telefono_fact" value="<?php echo $telefono_fact; ?>" id = "telefono_fact" maxlength = "10" onKeyPress="return valida(event)" / ></td></tr>
	<tr>
    <td><label>Email</label></td>
    <td><input type="email" name="email_fact" value="<?php echo $email_fact; ?>" id = "email_fact"/ ></td></tr>
