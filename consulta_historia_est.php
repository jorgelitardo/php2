	...
	//$id = $_GET['id'];
	$cod = $_GET['codigo'];
	$listado=  mysql_query("SELECT * FROM postulantes where reg=$cod and estado2='A'",$cn);
...
$cedula_fact=$reg['cedula_fact'];
$apellidos_fact=$reg['apellidos_fact'];
$nombres_fact=$reg['nombres_fact'];
$direccion_fact=$reg['direccion_fact'];
$telefono_fact=$reg['telefono_fact'];
$email_fact=$reg['email_fact'];
...
$estado=$reg['estado'];
$anio_lectivo=$reg['anio_lectivo'];
$medio_med = isset($reg['medio_med']) ? $reg['medio_med'] : NULL;$reg['medio_med'];
	    }
?>